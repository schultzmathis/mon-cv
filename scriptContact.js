function afficherEmail(nom, entreprise, email) {
    let mailto = `mailto:agathe.rabachou@centrale-med.fr?subject=Offre d'emploi&body=Bonjour, je suis ${nom} de l'entreprise ${entreprise} et je suis intéressé par ton profil pour une mission. Tu peux me recontacter pour en savoir plus à l'adresse ${email}`
